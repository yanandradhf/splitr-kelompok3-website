export async function GET(request) {
  try {
    ...
    const transactionsUrl = new URL('https://533c27f18d6b.ngrok-free.app/api/admin/transactions');
    ...
    if (paymentMethod) transactionsUrl.searchParams.set('payment_method', paymentMethod);
    ...
    const headers = ['No', 'Transaction ID', 'Transaction Date', 'Sender', 'Recipient', 'Amount', 'Branch Code', 'Payment Method', 'Status'];
